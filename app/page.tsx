        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 bg-[#FAF3E8] rounded-2xl">
              <img src="/icons/trabant.svg" className="w-12 h-12 text-[#2C1810]" alt="" />
              <h3 className="mt-4 text-xl font-semibold text-[#2C1810]">Retro zážitek</h3>
              <p className="mt-2 text-[#4A2F24]">Autentický zážitek z řízení legendárního vozu východního bloku</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-[#FAF3E8] rounded-2xl">
              <img src="/icons/clock.svg" className="w-12 h-12 text-[#2C1810]" alt="" />
              <h3 className="mt-4 text-xl font-semibold text-[#2C1810]">Víkendové půjčení</h3>
              <p className="mt-2 text-[#4A2F24]">Celý víkend na objevování krás Česka ve stylovém veteránu</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-[#FAF3E8] rounded-2xl">
              <img src="/icons/bag.svg" className="w-12 h-12 text-[#2C1810]" alt="" />
              <h3 className="mt-4 text-xl font-semibold text-[#2C1810]">Vše zahrnuto</h3>
              <p className="mt-2 text-[#4A2F24]">Plná nádrž, pojištění a technická podpora v ceně</p>
            </div>
          </div>
        </div>
      </section>
